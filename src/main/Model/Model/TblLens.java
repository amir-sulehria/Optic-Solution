...
public class TblLens {
    ...
    private TblSupplier tblSupplierByLSupplier;
    ...
    @Basic
    @Column(name = "l_supplier", nullable = true)
    ...
    public boolean equals(Object o) {
        ...
        return lId == tblLens.lId &&
                ...
                Objects.equals(lSupplier, tblLens.lSupplier);
    }

    @Override
    public int hashCode() {
        return Objects.hash(lId, lType, lMinquantity, lMaxquantity, lCurrentQuantity, lBasePrice, lSalePrice, lTaxPrice, lManufacturer, lSupplier);
    }
    ...
    @ManyToOne
    @JoinColumn(name = "l_supplier", referencedColumnName = "su_id")
    public TblSupplier getTblSupplierByLSupplier() {
        return tblSupplierByLSupplier;
    }

    public void setTblSupplierByLSupplier(TblSupplier tblSupplierByLSupplier) {
        this.tblSupplierByLSupplier = tblSupplierByLSupplier;
    }
